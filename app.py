...
import sqlite3, os, datetime, json, hashlib, secrets, functools, tempfile
...
_DATA_DIR = os.environ.get(
    "DATA_DIR",
    os.path.join(tempfile.gettempdir(), "buildmaster")
)
...
# Initialize database when imported by Vercel
try:
    init_db()
